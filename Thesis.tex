...
For this to be possible documents need to contain metadata which can describe their content in a way readable by computers.
This thesis will describe the development of a prototype that will help users add this metadata to their documents using only natural language.
The tool will utilize WordNet to disambiguate natural language, and as an intermediary to find mappings into formal ontologies.
