...
We also analyzed the results where the hypernym then siblings algorithm mapped incorrectly.
...
To test if we managed this we used pages that were already marked up with schema.org markup,
