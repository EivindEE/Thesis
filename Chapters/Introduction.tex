...
We chose to develop using node.js because it's a new and exciting technology that would make it possible to write
...
We will also need to solve the technical problems of how to import and export webpages from the artefact,
...
We want to make metadata accessible to content creators on the web that do not know enough about semantic web technologies
